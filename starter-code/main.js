      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "5":
            ...
            db.collection('companies').find({$and:[{founded_year:2004}],$or:[{founded_month:4},{founded_month:5},{founded_month:6}]}).sort({founded_day:-1, founded_month:-1}).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "7":
            ...
            db.collection('companies').find({},({name:1, number_of_employees:1})).sort({number_of_employees:-1}).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "10":
                ...
                db.collection('companies').find({name:"Facebook"},{products:1}).toArray((error, result) => {
                  if (error) {
                    console.log(error);
                    rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
                  } else {
          ...
          case "11":
            ...
            db.collection('companies').find({name:"Facebook"},{"relationships.person.permalink": 1, _id: 0 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "16":
            ...
            db.collection('companies').find({"offices.city":"London"}, {name:1, "offices.address1":1, "offices.address2":1, "offices.city":1, _id:0}).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "17":
            ...
            db.collection('companies').find({$and:[{tag_list:{$regex:"social-networking"}},{"offices.city":"New York"},{founded_year: {$gt: 2001}}, {founded_year: {$lt: 2017}}]},{name: 1, _id: 0}).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
